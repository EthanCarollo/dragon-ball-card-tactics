...
namespace Coffee.UIEffectInternal
{
    internal class ObjectRepository<T> where T : Object
    {
        ...
        private readonly Dictionary<ObjectId, Hash128> _objectKey = new Dictionary<ObjectId, Hash128>(8);
        ...
        private void Add(Hash128 hash, ref T obj, T newObject)
        {
            ...
            _objectKey[newObject.GetObjectId()] = hash;
        ...
        private void Remove(Entry entry)
        {
            ...
            _objectKey.Remove(entry.storedObject.GetObjectId());
            _pool.Push(entry);
            entry.reference = 0;
