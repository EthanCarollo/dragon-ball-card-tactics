...
[CreateAssetMenu(fileName = "UpgradeCharacterStarCard", menuName = "Card/UpgradeCharacterStarCard")]
public class UpgradeCharacterStarCard : Card
{

    public override string GetDescription()
    {
        return "Add a star to a character.";
    }
            ...
            (hit.collider.GetComponent<TileBehaviour>() != null || hit.collider.GetComponent<CharacterPrefabScript>() != null))
        {
            var charactersUpdatable =  GameManager.Instance.GetCharactersOnBoard()
                ...
                .FindAll(cha => {
                    ...
                    return cha.character.CanAddStar();
                });
